...
class User extends CI_Controller {
  ...
  public function edit() {
    ...
    if ($this->form_validation->run() == false) {
      ...
      // cek jika ada gambar yang ada di upload
      ...
      $this->db->update('user');
      $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Your profile has been updated successfully</div>');
      redirect('user');
    }
  }
