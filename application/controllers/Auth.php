...
class Auth extends CI_Controller {
  ...
  private function _sendEmail($token, $type) {
    $config = [
      ...
      'smtp_user' => 'amirulhidayat1030@gmail.com',
      'smtp_pass' => 'Rotibhaddad1030',
      'smtp_port' => 465,
      'mailtype' => 'html',
      'charset' => 'utf-8',
      'newline' => "\r\n",
    ...
    $this->email->from('amirulhidayat1030@gmail.com', 'Amirul Mukminin');
  ...
  public function changePassword() {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Password has been success changed, Please login</div>');
      redirect('auth');
    }
    }
}
