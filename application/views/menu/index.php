					...
					<tr>
						...
						<td>
							<a href="#" class="badge badge-danger" data-toggle="modal"
								data-target="#deleteModal<?= $m['menu']; ?>">delete</a>
						</td>
					</tr>
					<?php $i++ ?>
					<?php endforeach; ?>
...
<?php $i = 1; ?>
<?php foreach($menu as $m) : ?>
<div class="modal fade" id="deleteModal<?= $m['menu']; ?>" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a class="btn btn-primary" href="<?= base_url(); ?>menu/deleteMenu/<?= $m['menu']; ?>" da>Delete</a>
			</div>
		</div>
	</div>
</div>
